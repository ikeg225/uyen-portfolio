        ...
        <div className={styles.about}>
            <div className={styles.content}>
                ...
                <div className={styles.aboutme}>
                    ...
                    <p className={styles.details}>In my free time, I love “studying” and exploring different cafes. I am a borderline coffee addict but slowly transitioning to a matcha latta fanatic. I love playing with my doggo Luna and would advocate for her as the world's cutest and fluffiest doggo. Last summer, I interned at <span className={styles.bold}>Peet's Coffee</span> as their creative intern.</p>
